...
import { ScatterImportSetup } from "./import/Import";

const ScatterChartDefn = () => {
    ...
    const data: DatasetProperties = [
        ...
        {
            property: 'style', type: style({ type: "scatter" }),
    ...
    return (
        <div className="chart-container">
            <Grid data={data} header="# Scatter Chart Api" import={ScatterImportSetup} />
        </div>
    )

}

export default ScatterChartDefn;