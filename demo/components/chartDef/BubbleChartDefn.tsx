...
import { BubbleImportSetup } from "./import/Import";

const BubbleChartDefn = () => {
    ...
    const data: DatasetProperties = [
        ...
        {
            property: 'style', type: style({ type: "bubble" }),
    ...
    return (
        <div className="chart-container">
            <Grid data={data} header="# Bubble Chart Api" import={BubbleImportSetup} />
        </div>
    )

}

export default BubbleChartDefn;