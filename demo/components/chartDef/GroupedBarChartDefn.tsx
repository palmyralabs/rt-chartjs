...
import { GroupedBarImportSetup } from "./import/Import";

const GroupedBarChartDefn = () => {
    ...
    return (
        <div className="chart-container">
            <Grid data={data} header="# Grouped Bar Chart Api" import={GroupedBarImportSetup} />
        </div>
    )

}

export default GroupedBarChartDefn;